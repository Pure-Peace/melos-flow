...
pub contract MelosOpenBid {

    pub event MelosOpenBidInitialized()
    ...
    init () {
        self.OpenBidStoragePath = /storage/MelosOpenBid
        self.OpenBidPublicPath = /public/MelosOpenBid

        emit MelosOpenBidInitialized()
    }
}
